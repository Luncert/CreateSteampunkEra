...
import com.luncert.ccenhanced.content.common.SimpleDirection;
import com.luncert.ccenhanced.content.net.CCEPacketHandler;
import com.luncert.ccenhanced.content.net.CRobotPacket;
...
import static com.luncert.ccenhanced.content.robot.RobotMovement.MOVEMENT_SERIALIZER;
...
public class RobotEntity extends Entity implements IEntityAdditionalSpawnData {
    ...
    public RobotEntity(World world, BlockPos pos, BlockState blockState) {
        this(AllEntityTypes.ROBOT.get(), world);
